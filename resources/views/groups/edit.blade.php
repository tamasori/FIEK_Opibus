          ...
          <form class="user" method="post">
                ...
                @endif
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control" name="name" value="{{ old("name", $group->name) }}" placeholder="Név">
                    </div>
                    <hr />
                    <h3>Adminisztrációs engedélyek</h3>
                    <div class="form-group">
                        <div class="custom-control custom-checkbox small">
                        <input type="checkbox" class="custom-control-input" name="adminmenu-all" id="adminmenu-all" value="adminmenu-all" {{old("adminmenu-all",  $group->CanAccessMenu("all")) === false ? "": "checked"}}>
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                      <input type="checkbox" class="custom-control-input" name="adminmenu-{{$menu['perm']}}" id="{{$menu['perm']}}" value="{{$menu['perm']}}" {{old("adminmenu-".$menu['perm'], $group->CanAccessMenu($menu['perm'])) === false ? "": "checked"}}>
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox small">
                        <input type="checkbox" class="custom-control-input" name="labs-all" id="labs-all" value="labs-all" {{old("labs-all",  $group->CanAccessLab("all")) === false ? "": "checked"}}>
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                      <input type="checkbox" class="custom-control-input" name="lab-{{$lab['id']}}" id="{{$lab['id']}}" value="{{$lab['id']}}" {{old("lab-".$lab['id'], $group->CanAccessLab($lab['id'])) === false ? "": "checked"}}>
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox small">
                        <input type="checkbox" class="custom-control-input" name="items-all" id="items-all" value="items-all" {{old("items-all", $group->CanAccessItem("all")) === false ? "": "checked"}}>
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                      <input type="checkbox" class="custom-control-input" name="item-{{$item['id']}}" id="{{$item['id']}}" value="{{$item['id']}}" {{old("item-".$item['id'], $group->CanAccessItem($item['id'])) === false ? "": "checked"}}>
