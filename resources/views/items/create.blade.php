...
<h1 class="h3 mb-2 text-gray-800">Eszközök</h1>
          ...
          <form class="user" method="post">
                ...
                @endif
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="youtube_link" value="{{ old("youtube_link") }}" placeholder="Youtube link">
                    </div>

                    <div class="form-group">
                      <button id="file" type="button" class="btn btn-primary btn-sm">Kép</button>
                      <input type="text" id="file_url" name="file_url" value="{{old("file_url")}}">
                    </div>

                    <div class="form-group">
                        <div class="custom-control custom-checkbox small">
                          <input type="checkbox" class="custom-control-input" name="remote_access" id="customCheck" value="1" {{old("remote_access") === null ? "" : "checked"}}>
