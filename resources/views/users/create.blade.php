...
<h1 class="h3 mb-2 text-gray-800">Felhasználók</h1>
          ...
          <form class="user" method="post">
                ...
                @endif
                    ...
                    <div class="form-group">
                      <input type="email" class="form-control" id="exampleInputEmail" name="email" aria-describedby="emailHelp" value="{{ old("email") }}" placeholder="Email">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control" name="phone_number" value="{{ old("phone_number") }}" placeholder="Telefonszám">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control" name="github" value="{{ old("github") }}" placeholder="GitHub felhasználónév">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        <input type="checkbox" class="custom-control-input" name="userEnable" id="customCheck" value="1" {{old("userEnable") === null ? "" : "checked"}}>
